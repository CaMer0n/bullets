...
$BULLETS_TEMPLATE['menu']['item'] 	    = '<li>
			                            <div class="ms-list-icon animated zoomInUp {BULLET_ANIMATION_DELAY}">
			                            <span class="bullet-icon bullet-icon-circle bullet-icon-xlg label-{BULLET_ICON_STYLE} shadow-3dp">
			                              {BULLET_ICON}
			                            </span>
			                            </div>
			                            <div class="ms-list-text animated {BULLET_ANIMATION} {BULLET_ANIMATION_DELAY}">{BULLET_TEXT}</div>
			                        </li>';
